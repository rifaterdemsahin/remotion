           ...
           <div style={{
               ...
               {showPilot && (
                   <div style={{
                       ...
                       <img src={staticFile("images/delivery_pilot.png")} style={{ width: "100%" }} alt="Pilot" />
                   </div>
               )}
           </div>
    ...
    <AbsoluteFill style={{ backgroundColor: "#f5f6fa" }}>
        ...
        <Sequence from={0} durationInFrames={100}>
            ...
            <Scene 
                ...
                image={staticFile("images/gap_identification.png")}
            />
        </Sequence>
        ...
        <Sequence from={300} durationInFrames={100}>
            <Audio src={staticFile("sounds/whoosh.mp3")} />
             <Scene 
                ...
                image={staticFile("images/roadmap_journey.png")}
                showPilot={true}
            />
        </Sequence>
         ...
         <Sequence from={400} durationInFrames={100}>
            <Audio src={staticFile("sounds/pop.mp3")} />
             <Scene 
                ...
                image={staticFile("images/building_products.png")}
            />
        </Sequence>
        ...
        <Sequence from={500} durationInFrames={120}>
             ...
             <Scene 
                ...
                image={staticFile("images/certification_badge_final.png")}
            />
        </Sequence>
